        ...
        <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <ul>
              ...
              <li class="mb-4" wire:key="{{$brand->id}}">
                <label for="" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" class="w-4 h-4 mr-2" wire:model.live="selected_brand" id="{{$brand->slug}}" value="{{$brand->id}}">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="500" value="300" step="100">
