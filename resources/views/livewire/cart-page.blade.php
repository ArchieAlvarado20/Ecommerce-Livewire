    ...
    <div class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          <table class="w-full">
            ...
            <tbody>
              ...
              @empty
              <tr>
                <td colspan="3" class="text-center py-4 text-2xl">No items available in the cart</td>
              </tr>
              @endforelse
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          @if($cart_items)
          <a href="/checkout" class="bg-blue-900 block text-white py-2 px-4 rounded-lg mt-4 text-center w-full">Checkout</a>
          @endif
        </div>
      </div>
    </div>
