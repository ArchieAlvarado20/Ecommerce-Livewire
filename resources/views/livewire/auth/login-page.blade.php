      ...
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          ...
          <form wire:submit.prevent="save">
            @if(session('error'))
            <div class="mt-2 bg-red-600 text-sm text-white rounded-lg p-4" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-warning-label">
                  <span id="hs-solid-color-warning-label" class="font-bold">Warning</span> {{session('error')}}
              </div>
            @endif
