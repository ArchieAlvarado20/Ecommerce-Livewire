        ...
        <div class="p-4 sm:p-7">
          ...
          <form wire:submit.prevent="save">
            <div class="grid gap-y-4">
              ...
              <div class="flex justify-between items-center">
                  <label for="password" class="block text-sm mb-0 dark:text-white">Confirm Password</label>
                </div>
                <div class="relative">
                  <input type="password" id="password_confirmation" wire:model="password_confirmation" class="mb-2 py-3 border px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"  aria-describedby="password-error">
                ...
                @error('password_confirmation')
                <p class="text-xs text-red-600 mt-0" id="email-error">{{$message}}</p>
                @enderror
              </div>
              <!-- End Form Group -->
