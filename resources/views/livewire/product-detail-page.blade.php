    ...
    <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{url('storage', $product->image[0])}}'}">
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            @foreach ($product->image as $images)
              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage= '{{ url('storage',$images) }}'">
                <img src="{{url('storage',$images)}}" alt="{{$product->name}}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>
              @endforeach
        ...
        <div class="w-full px-4 md:w-1/2 ">
          <div class="lg:pl-20">
            <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-5">
              ...
              {!! Str::markdown($product->description) !!} {{--This is the conversion for summernote--}}
              </p>
            </div>
            <div class="w-32 mb-8 ">
